...
if(isset($_POST['publish'])) {
    ...
    $add = "INSERT INTO `seller_notes` (`SellerID`, `Title`, `DisplayPicture`, `NumberofPages`, `Description`, `UniversityName`, `Course`, `CourseCode`, `Professor`, `IsPaid`, `SellingPrice`, `NotesPreview`, `CreatedDate`) VALUES ({$_SESSION['userid']}, '{$title}', '{$display_picture}', '{$pages}', '{$description}', '{$university}', '{$course_name}', '{$course_code}', '{$professor}', b'{$ispaid}', '{$sell_price}', '{$note_preview}', now())";
    ...
    if (!file_exists("images/Members/".$_SESSION['userid']."/$note_id")) {
        mkdir("images/Members/".$_SESSION['userid']."/$note_id", 0777, true);
        mkdir("images/Members/".$_SESSION['userid']."/$note_id/Attachments", 0777, true);
    }
    ...
    move_uploaded_file($notes_temp, "images/Members/".$_SESSION['userid']."/$note_id/Attachments/$notes_name");
    ...
    $notes = "images/Members/".$_SESSION['userid']."/$note_id/Attachments/$notes_name";
    ...
    <section id="details">
        <div class="container-fluid">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-text">
                            ...
                            <input type="number" class="form-control" name="numberofPages" id="pages" placeholder="Enter number of note pages">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-text">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="Enter your price" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <button id="publish-btn" class="btn btn-form" type="submit" name="publish" data-toggle="modal" data-target="#exampleModalCenter">Publish</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="button" class="btn btn-primary" data-dismiss="modal" name="yes" value="Yes">
                            </div>
                        </div>
                    </div>
                </div>
