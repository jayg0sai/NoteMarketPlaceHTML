...
<body data-spy="scroll" data-target=".navbar">
    ...
    <section id="notes">
        <div class="container-fluid">
           <?php
            ...
            $note_count = "SELECT * FROM seller_notes WHERE Title LIKE '%$search%' ";
            $main = "";
            if(!empty($type)) {
            ...
            $search_query = "SELECT * FROM seller_notes WHERE Title LIKE '%$search%' ".$main."LIMIT $page1, 9 ";
    ...
    <nav id="pagination" aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <?php
            if($page>=2) {
                   echo '<li class="page-item number"><a class="page-link" href="search_engine.php?page='.($page - 1).'&source='.$search.'&type='.$type.'&category='.$category.'&universityname='.$universityname.'&course='.$course.'&country='.$country.'&rating='.$rating.'"></a></li>';
            }
