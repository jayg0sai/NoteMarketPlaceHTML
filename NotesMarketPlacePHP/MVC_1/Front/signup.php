...
<body>
    ...
    $message = "Error in sending email. Mailer Error: {$mail->ErrorInfo}";
        ...
        $message = "You have already verified your account with us";
        
        
} else {

$message = "You already have an account <br> please go below and click on login or verify your email";
}
} else {

$message = "Password mismatch or at least 8 character";
}
