...
$rejected_count_query = "SELECT * FROM seller_notes WHERE SellerID = '{$_SESSION['userid']}' AND Status = 14 ";
$rejected_count = mysqli_query($connection, $rejected_count_query);
    if(!$rejected_count) {
        die("Query Failed".mysqli_error($connection));
    }
$total_reject_count = mysqli_num_rows($rejected_count);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-md-5 m-t col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-4" onclick="window.location.href = 'myrejected.php'; " onMouseOver="this.style.cursor='pointer' ">
                            <div class="notes">
                                <h4><?php echo $total_reject_count; ?></h4>
