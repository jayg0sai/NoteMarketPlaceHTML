        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <form class="form-inline" action="mysold_search.php" method="post">
            ...
            <table class="table table-hover" style="width:100%;">
                ...
                <tbody>
                   <?php
                        ...
                        $seller_count = "SELECT * FROM downloads WHERE Seller = '{$_SESSION['userid']}' AND IsSellerHasAllowedDownload = b'1' ";
                        ...
                        $download_query = "SELECT * FROM downloads WHERE Seller = '{$_SESSION['userid']}' AND IsSellerHasAllowedDownload = b'1' ORDER BY AttachmentDownloadDate DESC LIMIT $page1,10 ";
...
?>
    ...
    <nav id="pagination" class="download-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="mysold.php?page='.($page - 1).'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="mysold.php?page='.$i.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="mysold.php?page='.$i.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="mysold.php?page='.($page + 1).'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
