...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/managetype.css?v=<?php echo time(); ?>">

    <!-- Responsive CSS -->
    <link rel="stylesheet" href="css/managetype-responsive.css?v=<?php echo time(); ?>">
    ...
    <section id="m-admin">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="addtype.php" role="button" id="btn-add" class="btn" title="add">Add Type</a>
                </div>
                <div class="col-md-8 col-sm-12">
                    <form class="form-inline" action="managetype.php" method="post">
                ...
                <tbody>
                   <?php
                        ...
                        if(isset($_POST['search'])) {
                            ...
                            $member_count = "SELECT * FROM note_types WHERE CONCAT(Name,Description,CreatedDate) LIKE '%$search%' ";
                            $member_query = "SELECT * FROM note_types WHERE CONCAT(Name,Description,CreatedDate) LIKE '%$search%' ORDER BY CreatedDate DESC LIMIT $page1,5 ";
                            ...
                            $search = "";
                            $member_count = "SELECT * FROM note_types ";
                            $member_query = "SELECT * FROM note_types ORDER BY CreatedDate DESC LIMIT $page1,5 ";
                        }
...
?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a role="button" href="action.php?type=<?php echo $type_id; ?>&action=inactive_t" class="btn btn-danger">Yes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <nav id="pagination2" class="publish-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="managetype.php?page='.($page - 1).'&source='.$search.'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="managetype.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="managetype.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="managetype.php?page='.($page + 1).'&source='.$search.'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
    ...
    <!-- Custom JS -->
    <script src="js/managetype.js?v=<?php echo time(); ?>"></script>
