...
?>
                ...
                <div class="col-md-8 col-sm-12">
                    <form class="form-inline" action="published.php" method="post">
                ...
                <tbody id="mytable">
                   <?php
                        ...
                        if(isset($_POST['search'])) {
                            ...
                            $download_query = "SELECT * FROM seller_notes WHERE Status = 13 ORDER BY PublishedDate DESC LIMIT $page1,5 ";
                        }
...
<?php } ?>
    ...
    <nav id="pagination2" class="publish-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="published.php?page='.($page - 1).'&source='.$search.'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="published.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="published.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="published.php?page='.($page + 1).'&source='.$search.'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
