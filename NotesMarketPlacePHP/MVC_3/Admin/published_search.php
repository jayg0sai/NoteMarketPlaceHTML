...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/published.css?v=<?php echo time(); ?>">

    <!-- Responsive CSS -->
    <link rel="stylesheet" href="css/published-responsive.css?v=<?php echo time(); ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php 
                        $fors_query = "SELECT DISTINCT SellerID FROM seller_notes WHERE Status = 13 ";
...
?>
                                <option value="<?php echo $fors_s; ?>"><?php echo $fors_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                ...
                <div class="col-md-8 col-sm-12">
                    <form class="form-inline" action="published_search.php" method="post">
            ...
            <table class="table table-hover" style="width:100%;">
                ...
                <tbody>
                   <?php
                        ...
                        $download_count = "SELECT * FROM seller_notes WHERE Status = 13 AND CONCAT(ActionedBy,PublishedDate,Title,Category,IsPaid,SellingPrice) LIKE '%$search%' ";
                        ...
                        $download_query = "SELECT * FROM seller_notes WHERE Status = 13 AND CONCAT(ActionedBy,PublishedDate,Title,Category,IsPaid,SellingPrice) LIKE '%$search%' ORDER BY PublishedDate DESC LIMIT $page1,5 ";
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="action.php?n_id=<?php echo $note_id; ?>&action=unpublish&name=<?php echo $seller_name; ?>&email=<?php echo $seller_email; ?>" method="post">
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div id="form-header">
...
<?php } ?>
    ...
    <nav id="pagination2" class="publish-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="published_search.php?page='.($page - 1).'&source='.$search.'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="published_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="published_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="published_search.php?page='.($page + 1).'&source='.$search.'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
    ...
    <!-- Custom JS -->
    <script src="js/published.js?v=<?php echo time(); ?>"></script>
