            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <form class="form-inline" action="inprog_search.php" method="post">
                        ...
                        <button name="search" type="submit" class="btn search">Search</button>
                    </form>
                </div>
            </div>
            <div style="overflow-x: auto;">
                <table class="table table-hover" style="width:100%;">
                    ...
                    if(isset($_POST['search'])) {
                        ...
                        $progress_count_1 = "SELECT * FROM seller_notes WHERE SellerID = '{$_SESSION['userid']}' AND Status IN (10,11,12) AND (Title LIKE '%$search%' OR Category LIKE '%$search%' OR SellingPrice LIKE '%$search%') ";
                        ...
                        $download_query_1 = "SELECT * FROM seller_notes WHERE SellerID = '{$_SESSION['userid']}' AND Status IN (10,11,12) AND (Title LIKE '%$search%' OR Category LIKE '%$search%' OR SellingPrice LIKE '%$search%') ORDER BY CreatedDate DESC LIMIT $page1,5 ";
...
?>
    ...
    <nav id="pagination1" class="progress-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="inprog_search.php?page='.($page - 1).'&source='.$search.'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count_1; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="inprog_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="inprog_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count_1)
                   echo '<li id="next" class="page-item"><a class="page-link" href="inprog_search.php?page='.($page + 1).'&source='.$search.'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
                ...
                <table class="table table-hover" style="width:100%;">
                    ...
                    <tbody>
                       <?php
                        ...
                        $progress_count = "SELECT * FROM seller_notes WHERE SellerID = '{$_SESSION['userid']}' AND Status = 13 ";
                        ...
                        $download_query = "SELECT * FROM seller_notes WHERE SellerID = '{$_SESSION['userid']}' AND Status = 13 ORDER BY CreatedDate DESC LIMIT $page1p,5 ";
...
?>
    ...
    <nav id="pagination2" class="publish-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($pagep>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="dashboard.php?pagep='.($pagep - 1).'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($j = 1; $j <= $page_count; $j++) {
                if($j == $pagep) {
                    echo '<li class="page-item number active"><a class="page-link" href="dashboard.php?pagep='.$j.'">'.$j.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="dashboard.php?pagep='.$j.'">'.$j.'</a></li>';
                }
                
                
            }
            if($pagep<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="dashboard.php?pagep='.($pagep + 1).'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
