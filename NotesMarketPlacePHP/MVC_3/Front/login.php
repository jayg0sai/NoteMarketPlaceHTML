...
if(isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM users WHERE EmailID = '$email' AND IsEmailVerified = b'1' AND IsActive = b'1' ";
    ...
    if($row > 0) {
        ...
        if($row['RoleID'] == 3) {
            ...
            global $connection;
            $user_profile_query = "SELECT UserID FROM user_profile WHERE UserID = '{$user}' ";
...
<body id="bg-img">
    <div class="center">
        ...
        <div id="content-box">
            <form action="login.php" method="post">
                ...
                <?php if(isset($invalid)) { echo "<div class='up'>".$invalid."</div>";} ?>
    ...
    $('#password-field').css('border','2px solid #d9534f');

    </script>
<?php } elseif(isset($invalid)) { ?>
    <script type="text/javascript">
    
    $('#password-field').css('border','1px solid #6255a5');
    ...
    $('#password-field').css('border','1px solid #6255a5');
    $('#email').css('border','1px solid #6255a5');
