            ...
            <table class="table table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    if(isset($_POST['search'])) {
                        ...
                        $download_count = "SELECT * FROM downloads WHERE Downloader = '{$_SESSION['userid']}' AND IsSellerHasAllowedDownload = b'1' AND (NoteTitle LIKE '%$search%' OR NoteCategory LIKE '%$search%' OR PurchasedPrice LIKE '%$search%') ";
                        ...
                        $download_query = "SELECT * FROM downloads WHERE Downloader = '{$_SESSION['userid']}' AND IsSellerHasAllowedDownload = b'1' AND (NoteTitle LIKE '%$search%' OR NoteCategory LIKE '%$search%' OR PurchasedPrice LIKE '%$search%') ORDER BY AttachmentDownloadDate DESC LIMIT $page1,10 ";
...
?>
    ...
    <nav id="pagination" class="download-p" aria-label="Page navigation example">
        <ul class="pagination">
            <?php
            if($page>=2) {
                   echo '<li id="prev" class="page-item"><a class="page-link" href="mydownload_search.php?page='.($page - 1).'&source='.$search.'"><img src="images/left-arrow.png" alt="arrow"></a></li>';
            }
            
            for($i = 1; $i <= $page_count; $i++) {
                if($i == $page) {
                    echo '<li class="page-item number active"><a class="page-link" href="mydownload_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                } else {
                    echo '<li class="page-item number"><a class="page-link" href="mydownload_search.php?page='.$i.'&source='.$search.'">'.$i.'</a></li>';
                }
                
                
            }
            if($page<$page_count)
                   echo '<li id="next" class="page-item"><a class="page-link" href="mydownload_search.php?page='.($page + 1).'&source='.$search.'"><img src="images/right-arrow.png" alt="arrow"></a></li>';
